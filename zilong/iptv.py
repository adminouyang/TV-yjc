...
# 读取 CCTV 频道列表
def load_cctv_channels(file_path="zilong/IPTV/CCTV.txt"):
    """从文件加载 CCTV 频道列表"""
    cctv_channels = set()
    try:
...
if __name__ == "__main__":
    ...
    cctv_channel_file = "zilong/IPTV/CCTV.txt"

    # 省份频道文件列表
    province_channel_files = [
        "zilong/IPTV/重庆频道.txt",
        "zilong /IPTV/四川频道.txt",
        "zilong /IPTV/云南频道.txt",
        "zilong /IPTV/安徽频道.txt",
        "zilong /IPTV/福建频道.txt",
        "zilong /IPTV/甘肃频道.txt",
        "zilong /IPTV/广东频道.txt",
        "zilong /IPTV/广西频道.txt",
        "zilong /IPTV/贵州频道.txt",
        "zilong /IPTV/海南频道.txt",
        "zilong /IPTV/河北频道.txt",
        "zilong /IPTV/河南频道.txt",
        "zilong /IPTV/黑龙江频道.txt",
        "zilong /IPTV/湖北频道.txt",
        "zilong /IPTV/湖南频道.txt",
        "zilong /IPTV/吉林频道.txt",
        "zilong /IPTV/江苏频道.txt",
        "zilong /IPTV/江西频道.txt",
        "zilong /IPTV/辽宁频道.txt",
        "zilong /IPTV/内蒙频道.txt",
        "zilong /IPTV/宁夏频道.txt",
        "zilong /IPTV/青海频道.txt",
        "zilong /IPTV/山东频道.txt",
        "zilong /IPTV/山西频道.txt",
        "zilong /IPTV/陕西频道.txt",
        "zilong /IPTV/上海频道.txt",
        "zilong /IPTV/天津频道.txt",
        "zilong /IPTV/卫视频道.txt",
        "zilong /IPTV/新疆频道.txt",
        "zilong /IPTV/云南频道.txt",
        "zilong /IPTV/浙江频道.txt",
        "zilong /IPTV/北京频道.txt"
    ]
