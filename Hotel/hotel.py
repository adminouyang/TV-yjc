...
CHANNEL_CATEGORIES = {
    ...
    "数字频道": [
        ...
        "4K电影","海看大片", "经典电影", "精彩影视", "喜剧影院", "动作影院", "精品剧场","抗战剧场", "IPTV戏曲", "求索纪录", "求索科学",
    ...
    "少儿频道": [
         "淘BABY","淘萌宠", "金色学堂", "动漫秀场", "金鹰卡通", "优漫卡通", "哈哈炫动", "嘉佳卡通","优优宝贝",
    ],
    "安徽频道": [
    ...
    "广东频道": [
        "广东影视", "广东少儿", "广东民生", "广东新闻", "广东经济科教", "广东体育", "广州新闻", "广东珠江","广东岭南戏曲", "深圳都市", "深圳少儿", "嘉佳卡通", "茂名综合","南山有线",
    ],
    "广西频道": [
