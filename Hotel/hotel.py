...
CHANNEL_CATEGORIES = {
    ...
    "河南频道": [
         "河南都市频道", "河南民生频道","河南法治频道", "河南电视剧频道", "河南新闻频道","河南公共频道","河南国际频道","梨园频道", "文物宝库","武术世界", 
    ],
    "河北频道": [
...
CHANNEL_MAPPING = {
    ...
    "凤凰卫视中文台": ["凤凰卫视中文台", "凤凰中文", "凤凰卫视","测试1","测试01",],
    ...
    "北京卡酷少儿": ["卡酷","卡酷少儿", "卡酷动画", "卡酷动漫", "北京卡酷","北京少儿","卡通卫视"], 
