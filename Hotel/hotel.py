...
CHANNEL_CATEGORIES = {
    ...
    "山东频道": [
         "山东综艺","山东影视", "山东齐鲁", "山东农科","山东体育休闲","山东生活", "山东少儿","济南文旅体育","烟台新闻","山东教育", "临沂导视", "临沂图文", "临沂综合", "临沂农科", "兰陵导视", 
         "兰陵公共", "兰陵综合"
    ],
    "山西频道": [
    ...
    "广东频道": [
        "广东影视", "广东少儿", "广东民生", "广东新闻", "广东经济科教", "广东体育", "广州新闻", "广东珠江","广东岭南戏曲", "深圳都市", "深圳少儿", "嘉佳卡通", "茂名综合","南山有线","汕尾新闻综合",
    ],
    "广西频道": [
    ...
    "江西频道": [
        "江西都市","江西经济生活","江西指南","抚州综合","赣州新闻综合","赣州经济生活","章贡综合",   
    ],    
    "福建频道": [
        "福建综合", "福建教育","乡村振兴公共频道"
    ], 
...
CHANNEL_MAPPING = {
    ...
    "CCTV13": ["CCTV13", "CCTV-13", "CCTV13新闻", "CCTV13高清", "CCTV13HD", "cctv13","中央13台","sCCTV13-新闻","CCTV-新闻"],
